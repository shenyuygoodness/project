...
//     if (_threatAlerts) {
//       _showNotification('Threat Alert', 'New threat intelligence report available!');
//     }
//     // Add similar logic for other notifications if needed
//   }
...
//               subtitle: const Text('Access threat intelligence data even without an internet connection.'),
//               value: _offlineMode,
//               onChanged: (value) {
//                 setState(() {
//                   _offlineMode = value;
...
//               subtitle: const Text('Switch between light and dark themes for optimal viewing.'),
//               value: _darkTheme,
//               onChanged: (value) {
//                 setState(() {
//                   _darkTheme = value;
